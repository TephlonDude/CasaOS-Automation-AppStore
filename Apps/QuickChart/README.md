...
Generate charts from URLs for embedding in documents and dashboards

## 🚀 Features

- Chart generation from URL parameters
...
**Port Mapping**
- QuickChart listens on port \$(System.Collections.Hashtable.MainPort)\ inside the container
- Mapped to host port \$(System.Collections.Hashtable.MainPort)\ (configurable in compose file)

**Persistent Storage**
- Data is stored at \/DATA/AppData/quickchart\ on your CasaOS host
...
- **Backup Data:** Regularly back up \/DATA/AppData/quickchart\ to protect your configuration and data
...
- [https://quickchart.io/documentation](https://quickchart.io/documentation)
